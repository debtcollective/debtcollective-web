...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collective.image'
        db.add_column(u'collectives_collective', 'image',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collective.image'
        db.delete_column(u'collectives_collective', 'image')
