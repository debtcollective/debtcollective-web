...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Collective', fields ['slug']
        db.create_unique(u'collectives_collective', ['slug'])

        # Adding unique constraint on 'Action', fields ['slug']
        db.create_unique(u'collectives_action', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Action', fields ['slug']
        db.delete_unique(u'collectives_action', ['slug'])

        # Removing unique constraint on 'Collective', fields ['slug']
        db.delete_unique(u'collectives_collective', ['slug'])
