...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.link'
        db.add_column(u'collectives_action', 'link',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)

        # Adding field 'Action.image'
        db.add_column(u'collectives_action', 'image',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.link'
        db.delete_column(u'collectives_action', 'link')

        # Deleting field 'Action.image'
        db.delete_column(u'collectives_action', 'image')
    ...
    models = {
        ...
        u'collectives.action': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True'}),
