...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollectiveMember'
        db.create_table(u'collectives_collectivemember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('collective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collectives.Collective'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1)),
        ))
        db.send_create_signal(u'collectives', ['CollectiveMember'])


    def backwards(self, orm):
        # Deleting model 'CollectiveMember'
        db.delete_table(u'collectives_collectivemember')
